...
![Star schema data model](screenshots/Start_Schema_Data_Model.png)

## Report pages

**Financial & Operational Overview**
![Financial overview dashboard](screenshots/Financial_Overview_Dashboard.png)

**Patient Demographics & Diagnosis Patterns**
![Patient demographics dashboard](screenshots/Patient_Demographics_Dashboard.png)

**Readmissions & Quality Insights**
![Readmissions dashboard](screenshots/Readmission_Dashboard.png)
